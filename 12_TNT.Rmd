...
```{R tnt-iw-nok2, echo=FALSE, fig.cap="(ref:tnt-no2-cons) (ref:tnt-node-freq)"}
...
PlotPanel(tnConsensi, 1, './TNT/xpiwe2.sym')
PlotPanel(tnConsensi, 2, './TNT/xpiwe3.sym')
PlotPanel(tnConsensi, 3, './TNT/xpiwe4.5.sym')
```
