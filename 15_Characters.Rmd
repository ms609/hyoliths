...
```{R all-changes, echo=FALSE, fig.height=6, fig.width=8, fig.cap="(ref:all-changes)"}
...
if (knitr::is_html_output()) {
  ...
  conY[child[child <= conTip]] <- seq(treeYMargins[1], svgHeight-treeYMargins[2], len=conTip)
  ...
  tips <- paste0('<text x="', (conX[terminal] + 0L), 
                 ...
                 collapse='')
  nodes <- paste0('<text x="', (conX[internal] + 2L), 
                  '" y="', conY[internal] + textY,
                  '" id="nr', internal, '" class="node"><tspan class="b44">',
                  majLabels['changes', ], '</tspan><br /><tspan class="b42">',
                  majLabels['regions'], '</tspan><br /><tspan class="b41">', 
                  majLabels['fitches'], '</tspan></text>', collapse='')
  conCaption <- paste0('<text x="', svgWidth - 4L,
               '" y="', yStep + textY, '" text-anchor="end" class="stepsLabel">',
                '<tspan class="score b41">Red</tspan>: Logically invalid Fitch steps<br />Rokey-dokey',
               '</text><text x="', svgWidth - 4L, '" y="', (yStep * 2) + textY, 
               '" text-anchor="end" class="stepsLabel">',
               '<tspan class="score">Blue</tspan>: additional region</text>')
