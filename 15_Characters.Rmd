...
for (i in seq_len(n_char)) {
  ...
  legend_labels <- my_states[[i]]
  
  # Plot character reconstruction:
  PlotCharacterMapping(char = my_chars[, i], stateLabels = legend_labels,
  ...
  if (!is.null(getOption('localInstance')) || knitr::is_html_output()) {
    ...
    cat(paste0('>  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="',
               getOption('svgWidth'),
               '" height="', lineHeight * length(legend_labels) + lineHeight - 5L,
               # For T/N statement
               '" class="statesLegend">',
