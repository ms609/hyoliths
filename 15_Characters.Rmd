...
if (knitr::is_html_output()) {
  ...
  nodes <- paste0('<text x="', (conX[internal] + 2L), 
                  ...
                  majLabels['changes', ], '</tspan><tspan class="b42" x="0" dy="1.2em">',
                  majLabels['regions', ], '</tspan><tspan class="b41" x="0" dy="1.2em">', 
                  majLabels['fitches', ], '</tspan></text>', collapse='')
  conCaption <- paste0('<text x="', svgWidth - 4L,
               '" y="', yStep + textY, '" text-anchor="end" class="stepsLabel">',
                '<tspan class="score b41">Red</tspan>: Logically invalid Fitch steps',
