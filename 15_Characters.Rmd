...
if (knitr::is_html_output()) {
  ...
  nodes <- paste0('<g transform="translate(', conX[internal] + 2L, 
                  ...
                  '"><text x="0" y="0" class="node"><tspan class="b42" dy="-1.2em">',
  ...
  conCaption <- paste0('<g transform="translate(', svgWidth - 4L, ' ', yStep + textY, 
                       ')"><text x="0" y="0" text-anchor="end" class="stepsLabel">',
                       '<tspan x="0" dy="1.2em">',
                       '<tspan class="score b44">Blue</tspan>: ',
                       'Character transformation</tspan>', 
                       ...
                       '<tspan x="0" dy="1.2em">Click node for details</tspan>',
                       '</text></g>')
