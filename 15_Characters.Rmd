...
rootedTrees <- lapply(trees, RootTree, outgroupTips=rootingTips)
...
function toggleDetails() {
  $('div.state-notes').toggle();
  $togglers = $("div.toggleDetails");
  if ($togglers.first().children().html() == "[Hide details]") {
    $togglers.children().html("[Show details]")
  } else {
    $togglers.children().html("[Hide details]")
  }
}
...
$(document).ready(function() {
  ...
  $('div.state-notes').each(function() {
      var theseNotes = $(this);
      var togglerClone = originalToggler.clone().insertBefore(theseNotes);
    }
  );
...
if (exists('localInstance') || knitr::is_html_output()) {
  cat(paste0('<div class="switcher">',
    ...
    '</div><div class="toggleDetails"><a href="javascript:toggleDetails();">',
    '[Hide details]</a></div>'))
}
```
