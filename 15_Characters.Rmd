...
subheadings <- c("Adult setae: Composition", "Digestive tract: Anus: Presence",
                 paste("Sclerites:",
                       c("Bivalved", "Dorsal valve", "Ventral valve",
                         "Ornament", "Composition", "Structure")),
                 "Gametes: Spermatozoa", paste("Larva:", c("Cilia", 
