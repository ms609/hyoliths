...
We document the results of tree searches using
\protect\hyperlink{fitch}{Fitch parsimony} and a
\protect\hyperlink{bayesian}{Bayesian method}, with the caveat that both
approaches are subject to errors resulting from logically incoherent
treatment of inapplicable data \citep{Maddison1993}.

To meet this criticism, we also present the results of tree searches
...
Analysis was performed on a new matrix of 53 lophotrochozoan taxa, coded
...
the main manuscript.{]} a static version can be downloaded directly from
-
\url{https://raw.githubusercontent.com/ms609/hyoliths/master/mbank_X24932_6-15-2018_429.nex}
(Nexus format) -
\url{https://raw.githubusercontent.com/ms609/hyoliths/master/mbank_X24932_6-14-2018_555.tnt}
(TNT format)

Taxa were chosen to include previously proposed affinities for hyoliths
(sipunculans, molluscs). As a brachiozoan affinity is indicated,
additional brachiozoan taxa were incorporated in order to resolve the
position of hyoliths within this group.
...
\hline
\_Cupitheca holocyclata\_ & 63 & \_Serpula\_ & 170 & \_Glyptoria\_ & 73\\
\hline
\_Bactrotheca\_ & 53 & \_Tonicella\_ & 188 & \_Heliomedusa orienta\_ & 67\\
\hline
\_Conotheca\_ & 60 & \_Dentalium\_ & 169 & \_Kutorgina chengjiangensis\_ & 84\\
\hline
...
\hline
\_Loxosomella\_ & 164 & \_Micromitra\_ & 81 & \_Nisusia sulcata\_ & 80\\
\hline
\_Flustra\_ & 168 & \_Antigonambonites planus\_ & 85 & \_Orthis\_ & 70\\
\hline
\_Amathia\_ & 157 & \_Botsfordia\_ & 75 & \_Paterimitra\_ & 67\\
\hline
\_Novocrania\_ & 186 & \_Clupeafumosus socialis\_ & 76 & \_Salanygolina\_ & 79\\
\hline
...
\hline
\_Phoronis\_ & 169 & \_Eoobolus\_ & 81 & \_Yuganotheca elegans\_ & 56\\
\hline
\end{tabular}
...
\hline
TL\{all\} & 10.000 & 0.51100 & 399 & 479 & 1.0000\\
\hline
m\{1\} & 0.454 & 0.00252 & 191 & 295 & 1.0006\\
\hline
\end{tabular}
...
\addcontentsline{toc}{subsection}{{[}67{]} Reduced}
...
\addcontentsline{toc}{subsection}{{[}68{]} Arrangement}
...
\addcontentsline{toc}{subsection}{{[}69{]} Symmetry}
...
\addcontentsline{toc}{subsection}{{[}70{]} Hinge line shape}
...
\addcontentsline{toc}{subsection}{{[}72{]} Commissure: Exact
...
\addcontentsline{toc}{subsection}{{[}73{]} Commissure: Sulcate}
...
\addcontentsline{toc}{subsection}{{[}74{]} Commissure: Circular}
...
\addcontentsline{toc}{subsection}{{[}75{]} Commissure: Lateral margins}
...
\addcontentsline{toc}{subsection}{{[}76{]} Apophyses}
...
\addcontentsline{toc}{subsection}{{[}77{]} Apophyses: Morphology}
...
\addcontentsline{toc}{subsection}{{[}78{]} Apophyses: Dental plates}
...
\addcontentsline{toc}{subsection}{{[}79{]} Sockets}
...
\addcontentsline{toc}{subsection}{{[}80{]} Socket ridges}
...
\addcontentsline{toc}{subsection}{{[}83{]} Muscle scars: Adjustor}
...
\addcontentsline{toc}{subsection}{{[}85{]} Muscle scars: Adductors:
Position}
...
\addcontentsline{toc}{subsection}{{[}86{]} Muscle scars: Dermal muscles}
...
\hypertarget{Kutorgina_chengjiangensis-coding-86}{}
...
\addcontentsline{toc}{subsection}{{[}87{]} Muscle scars: Unpaired median
(\emph{levator ani})}
...
\addcontentsline{toc}{subsection}{{[}90{]} Growth direction}
...
\addcontentsline{toc}{subsection}{{[}92{]} Differentiated posterior
surface: Morphology}
...
\addcontentsline{toc}{subsection}{{[}93{]} Posterior surface: Medial
groove}
...
\addcontentsline{toc}{subsection}{{[}97{]} Notothyrial platform}
...
\addcontentsline{toc}{subsection}{{[}98{]} Medial septum}
...
\addcontentsline{toc}{subsection}{{[}99{]} Cardinal shield}
...
\addcontentsline{toc}{subsection}{{[}100{]} Cardinal processes}
...
\addcontentsline{toc}{subsection}{{[}101{]} Cardinal teeth}
...
\addcontentsline{toc}{subsection}{{[}102{]} Clavicles}
...
\addcontentsline{toc}{subsection}{{[}103{]} Clavicles: Type of
clavicles}
...
\addcontentsline{toc}{subsection}{{[}104{]} Relative size}
...
\addcontentsline{toc}{subsection}{{[}107{]} Posterior margin growth
direction}
...
\addcontentsline{toc}{subsection}{{[}108{]} Posterior surface: Planar}
...
\addcontentsline{toc}{subsection}{{[}109{]} Ligula}
...
\addcontentsline{toc}{subsection}{{[}110{]} Posterior surface: Extent}
...
\addcontentsline{toc}{subsection}{{[}119{]} Umbonal perforation}
...
\addcontentsline{toc}{subsection}{{[}120{]} Umbonal perforation: Shape}
...
\addcontentsline{toc}{subsection}{{[}121{]} Colleplax, cicatrix or
pedicle sheath}
...
\addcontentsline{toc}{subsection}{{[}122{]} Median septum}
...
\addcontentsline{toc}{subsection}{{[}125{]} Radial ornament}
...
\addcontentsline{toc}{subsection}{{[}126{]} Shell-penetrating spines}
...
\addcontentsline{toc}{subsection}{{[}127{]} Mineralogy}
...
\addcontentsline{toc}{subsection}{{[}128{]} Cuticle or organic matrix}
...
\addcontentsline{toc}{subsection}{{[}129{]} Incorporation of sedimentary
particles}
...
\addcontentsline{toc}{subsection}{{[}130{]} Periostracum: Flexibility}
...
\addcontentsline{toc}{subsection}{{[}131{]} Microstructure: Number of
distinct layers}
...
\addcontentsline{toc}{subsection}{{[}132{]} Microstructure: Format}
...
\addcontentsline{toc}{subsection}{{[}133{]} Stratiform lamellae
...
\addcontentsline{toc}{subsection}{{[}134{]} Stratiform laminae
separated}
...
\addcontentsline{toc}{subsection}{{[}135{]} Stratiform laminae with
polygonal ornament}
...
\addcontentsline{toc}{subsection}{{[}136{]} Canals}
...
\addcontentsline{toc}{subsection}{{[}137{]} Punctae}
...
\addcontentsline{toc}{subsection}{{[}138{]} Pseudopunctae}
...
\addcontentsline{toc}{subsection}{{[}139{]} External polygonal ornament}
...
\addcontentsline{toc}{subsection}{{[}140{]} Periodically shed and
replaced}
...
\addcontentsline{toc}{subsection}{{[}141{]} Egg size}
...
\addcontentsline{toc}{subsection}{{[}142{]} Gonocoel}
...
\addcontentsline{toc}{subsection}{{[}143{]} Ovary wall saccular}
...
\addcontentsline{toc}{subsection}{{[}144{]} Testis wall saccular}
...
\addcontentsline{toc}{subsection}{{[}145{]} Asexual reproduction}
...
\addcontentsline{toc}{subsection}{{[}147{]} Sexes}
