...
\caption{\label{tab:mrbayes-parameter-summary}Parameter estimates. Convergence was indicated by PSRF
= 1.00 and an estimated sample size of \textgreater{} 200 for each
parameter.}
\centering
