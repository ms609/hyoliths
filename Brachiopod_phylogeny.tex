...
under \(3 \leq k \leq 24\). Each node is labelled with its frequency in the set
...
\caption{\label{fig:tnt-iw-indiv-1}Strict consensus of all trees recovered by TNT
using Fitch parsimony with implied weighting at \emph{k} = 3 and 4.5.
Nodes labelled with jackknife frequencies (\%). The strict consensus of all implied weights
