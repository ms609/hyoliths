...
The complete dataset comprises 10704 character codings, of which 987 are
inapplicable and 4528 were neither ambiguous nor inapplicable. The
...
\hline
 &  &  &  &  & \\
\hline
\_Namacalathus\_ & 59   \&nbsp; & \_Wiwaxia corrugata\_ & 73   \&nbsp; & \_Heliomedusa orienta\_ & 64   \&nbsp;\\
\hline
\_Haplophrentis carinatus\_ & 79   \&nbsp; & \_Halkieria evangelista\_ & 58   \&nbsp; & \_Kutorgina chengjiangensis\_ & 80   \&nbsp;\\
\hline
\_Pedunculotheca diania\_ & 64   \&nbsp; & \_Dailyatia\_ & 54   \&nbsp; & \_Lingulosacculus\_ & 58   \&nbsp;\\
\hline
\_Cotyledion tylodes\_ & 63   \&nbsp; & \_Acanthotretella spinosa\_ & 67   \&nbsp; & \_Lingulellotreta malongensis\_ & 84   \&nbsp;\\
\hline
\_Loxosomella\_ & 163   \&nbsp; & \_Alisina\_ & 81   \&nbsp; & \_Longtancunella chengjiangensis\_ & 58   \&nbsp;\\
\hline
\_Flustra\_ & 167   \&nbsp; & \_Askepasma toddense\_ & 76   \&nbsp; & \_Micrina\_ & 68   \&nbsp;\\
\hline
\_Amathia\_ & 155   \&nbsp; & \_Micromitra\_ & 78   \&nbsp; & \_Mickwitzia muralensis\_ & 71   \&nbsp;\\
\hline
\_Novocrania\_ & 186   \&nbsp; & \_Antigonambonites planus\_ & 83   \&nbsp; & \_Mummpikia nuda\_ & 53   \&nbsp;\\
\hline
\_Pelagodiscus atlanticus\_ & 163   \&nbsp; & \_Botsfordia\_ & 73   \&nbsp; & \_Nisusia sulcata\_ & 78   \&nbsp;\\
\hline
\_Lingula\_ & 203   \&nbsp; & \_Clupeafumosus socialis\_ & 75   \&nbsp; & \_Orthis\_ & 68   \&nbsp;\\
\hline
\_Terebratulina\_ & 180   \&nbsp; & \_Coolinia pecten\_ & 78   \&nbsp; & \_Paterimitra\_ & 63   \&nbsp;\\
\hline
\_Phoronis\_ & 169   \&nbsp; & \_Craniops\_ & 65   \&nbsp; & \_Salanygolina\_ & 77   \&nbsp;\\
\hline
\_Sipunculus\_ & 167   \&nbsp; & \_Eccentrotheca\_ & 54   \&nbsp; & \_Siphonobolus priscus\_ & 73   \&nbsp;\\
\hline
\_Serpula\_ & 170   \&nbsp; & \_Eoobolus\_ & 79   \&nbsp; & \_Tomteluva perturbata\_ & 57   \&nbsp;\\
\hline
\_Tonicella\_ & 184   \&nbsp; & \_Gasconsia\_ & 69   \&nbsp; & \_Ussunia\_ & 52   \&nbsp;\\
\hline
\_Dentalium\_ & 166   \&nbsp; & \_Glyptoria\_ & 71   \&nbsp; & \_Yuganotheca elegans\_ & 52   \&nbsp;\\
\hline
\end{tabular}
...
\url{https://raw.githubusercontent.com/ms609/hyoliths/master/mbank_X24932_6-11-2018_734.nex}
.
...
inapplicable codings (987/10704 = 9.2\% of tokens), which are known to
...
\addcontentsline{toc}{subsection}{{[}93{]} Cardinal shield}
...
\addcontentsline{toc}{subsection}{{[}94{]} Cardinal processes}
...
\addcontentsline{toc}{subsection}{{[}95{]} Medial septum}
...
\addcontentsline{toc}{subsection}{{[}96{]} Clavicles}
...
\addcontentsline{toc}{subsection}{{[}97{]} Clavicles: Type of clavicles}

\begin{verbatim}
## Warning in plot.states.matrix(apply.reconstruction(trees[[1]],
## my_chars_i), : State labels do not seem to match states. You need to label
## all states from 0 to the maximum observed.
\end{verbatim}
...
\addcontentsline{toc}{subsection}{{[}134{]} Rods}
...
\addcontentsline{toc}{subsection}{{[}135{]} External polygonal ornament}
...
\addcontentsline{toc}{subsection}{{[}136{]} Periodically shed and
replaced}
...
\addcontentsline{toc}{subsection}{{[}137{]} Egg size}
...
\addcontentsline{toc}{subsection}{{[}138{]} Gonocoel}
...
\addcontentsline{toc}{subsection}{{[}139{]} Ovary wall saccular}
...
\addcontentsline{toc}{subsection}{{[}140{]} Testis wall saccular}
...
\addcontentsline{toc}{subsection}{{[}141{]} Asexual reproduction}
...
\addcontentsline{toc}{subsection}{{[}142{]} Fertilization}
...
\addcontentsline{toc}{subsection}{{[}143{]} Sexes}
...
\addcontentsline{toc}{subsection}{{[}144{]} Protective membrane}
...
\addcontentsline{toc}{subsection}{{[}146{]} Nucleus: Shape}
...
\addcontentsline{toc}{subsection}{{[}147{]} Anterior nuclear fossa}
...
\addcontentsline{toc}{subsection}{{[}148{]} Acrosome: Shape}
...
\addcontentsline{toc}{subsection}{{[}149{]} Acrosome: Differentiated
internally}
...
\addcontentsline{toc}{subsection}{{[}150{]} Acrosome: Sub-acrosomal
space}
...
\addcontentsline{toc}{subsection}{{[}151{]} Mid-piece}
...
\addcontentsline{toc}{subsection}{{[}152{]} Centrioles: Orientation}
...
\addcontentsline{toc}{subsection}{{[}153{]} Centrioles: Fusion}
...
\addcontentsline{toc}{subsection}{{[}154{]} Satellite fibre complex}
...
\addcontentsline{toc}{subsection}{{[}155{]} Mitochondria: Shape}
...
\addcontentsline{toc}{subsection}{{[}156{]} Mitochondria: Cristae:
Configuration}
...
\addcontentsline{toc}{subsection}{{[}157{]} Mitochondria: Midpiece}
...
\addcontentsline{toc}{subsection}{{[}158{]} Equal}
...
\addcontentsline{toc}{subsection}{{[}159{]} Cross pattern}
...
\addcontentsline{toc}{subsection}{{[}160{]} Polar lobe formation}
...
\addcontentsline{toc}{subsection}{{[}161{]} Spiral}
...
\addcontentsline{toc}{subsection}{{[}163{]} Origin of mesoderm}
...
\addcontentsline{toc}{subsection}{{[}164{]} Metatroch}
...
\addcontentsline{toc}{subsection}{{[}165{]} Telotroch}
...
\addcontentsline{toc}{subsection}{{[}166{]} Feeding}
...
\addcontentsline{toc}{subsection}{{[}167{]} Ciliated food groove}
...
\addcontentsline{toc}{subsection}{{[}168{]} Ciliary bands: Downstream}
...
\addcontentsline{toc}{subsection}{{[}169{]} Ciliary bands: Upstream}
...
\addcontentsline{toc}{subsection}{{[}170{]} Adoral ciliary band}
...
\addcontentsline{toc}{subsection}{{[}172{]} Muscles extending to the
hyposphere}
...
\addcontentsline{toc}{subsection}{{[}173{]} Serotonergic cells}
...
\addcontentsline{toc}{subsection}{{[}174{]} Develops into adult brain}
...
\addcontentsline{toc}{subsection}{{[}176{]} Serotonin-like
...
\addcontentsline{toc}{subsection}{{[}177{]} Origin of body cavity}
...
\addcontentsline{toc}{subsection}{{[}178{]} Formation of coelomoducts}
...
\addcontentsline{toc}{subsection}{{[}179{]} Pedal gland}
...
\addcontentsline{toc}{subsection}{{[}180{]} Paired}
...
\addcontentsline{toc}{subsection}{{[}181{]} Paried: Includes
pericardium}
...
\addcontentsline{toc}{subsection}{{[}182{]} Foot}
...
\addcontentsline{toc}{subsection}{{[}183{]} Accessory centriole}
...
\addcontentsline{toc}{subsection}{{[}184{]} Aggregation of granules
below basal plate}
...
\addcontentsline{toc}{subsection}{{[}185{]} Radiating tubular fibres}
...
\addcontentsline{toc}{subsection}{{[}187{]} Brushborder of microvilli}
...
\addcontentsline{toc}{subsection}{{[}188{]} Centriolar triplet
...
\addcontentsline{toc}{subsection}{{[}189{]} Ciliary necklace with
connecting strands}
...
\addcontentsline{toc}{subsection}{{[}190{]} Presence}
...
\addcontentsline{toc}{subsection}{{[}191{]} Origin}
...
\addcontentsline{toc}{subsection}{{[}193{]} Branched}
...
\addcontentsline{toc}{subsection}{{[}196{]} Presence}
...
\addcontentsline{toc}{subsection}{{[}199{]} Podocytes}
...
\addcontentsline{toc}{subsection}{{[}200{]} Rhogocytes}
...
\addcontentsline{toc}{subsection}{{[}201{]} Serve as excretory organs}
...
\addcontentsline{toc}{subsection}{{[}202{]} Protonephridia}
...
\addcontentsline{toc}{subsection}{{[}203{]} Metanephridia}
...
\addcontentsline{toc}{subsection}{{[}204{]} Layers}
...
\addcontentsline{toc}{subsection}{{[}205{]} Composition}
...
\addcontentsline{toc}{subsection}{{[}206{]} Fibrous layer with thick
fibrils}
...
\addcontentsline{toc}{subsection}{{[}207{]} Homogeneous layer}
...
\addcontentsline{toc}{subsection}{{[}208{]} Resilience}
...
\addcontentsline{toc}{subsection}{{[}209{]} Microvilli}
...
\addcontentsline{toc}{subsection}{{[}210{]} Cytology}
...
\addcontentsline{toc}{subsection}{{[}211{]} Histology}
...
\addcontentsline{toc}{subsection}{{[}212{]} Pedal gland}
...
\addcontentsline{toc}{subsection}{{[}213{]} Paired pharyngeal
diverticulae}
...
\addcontentsline{toc}{subsection}{{[}215{]} Orthogonal}
...
\addcontentsline{toc}{subsection}{{[}216{]} Glial system}
...
\addcontentsline{toc}{subsection}{{[}217{]} Buccal nerve ring}
...
\addcontentsline{toc}{subsection}{{[}218{]} Anterior nerve loop}
...
\addcontentsline{toc}{subsection}{{[}219{]} Formation of ganglia}
...
\addcontentsline{toc}{subsection}{{[}220{]} Presence}
...
\addcontentsline{toc}{subsection}{{[}221{]} Fused}
...
\addcontentsline{toc}{subsection}{{[}223{]} Ventral longitudinal nerves}
