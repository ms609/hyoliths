...
\begin{verbatim}
## Warning in grepl("setae and 3D MicroCT", title, fixed = TRUE, ignore.case =
...
\textbf{Fig. S1. \emph{Pedunculotheca diania} Sun, Zhao et Smith gen. et
...
\emph{Pedunculotheca diania} Sun, Zhao et Smith gen. et sp. nov.} NIGPAS
