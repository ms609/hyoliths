...
The complete dataset comprises 12204 character codings, of which 1134
...
\hline
\_Bactrotheca\_ & 53   \&nbsp; & \_Tonicella\_ & 189   \&nbsp; & \_Heliomedusa orienta\_ & 67   \&nbsp;\\
\hline
...
\hline
\_Pauxillites\_ & 56   \&nbsp; & \_Acanthotretella spinosa\_ & 70   \&nbsp; & \_Micrina\_ & 71   \&nbsp;\\
\hline
...
\url{https://raw.githubusercontent.com/ms609/hyoliths/master/mbank_X24932_6-14-2018_456.nex}
.
...
inapplicable codings (1134/12204 = 9.3\% of tokens), which are known to
...
\NormalTok{ew.tree <-}\StringTok{ }\KeywordTok{Ratchet}\NormalTok{(start.tree, my_data, }\DataTypeTok{verbosity=}\NormalTok{0L,}
                   \DataTypeTok{ratchHits =} \DecValTok{60}\NormalTok{, }\DataTypeTok{searchHits=}\DecValTok{55}\NormalTok{, }\CommentTok{# ratchHits = 20 not enough}
                   \DataTypeTok{swappers=}\KeywordTok{list}\NormalTok{(RootedTBRSwap, RootedSPRSwap, RootedNNISwap))}
...
{/* Repeat this block for each value of k \&\#42/}
\end{quote}
...
are present in each tree might be more easily observed. Node labels
...
\hline
TL\{all\} & 9.880 & 0.49400 & 5610 & 6070 & 1.00000\\
\hline
m\{1\} & 0.467 & 0.00276 & 1960 & 3370 & 0.99995\\
\hline
\end{tabular}
...
posterior probability \textgreater{} 50\%, all taxa; notes labelled with
