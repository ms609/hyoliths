...
203 morphological characters (127 neomorphic, 76 transformational).
...
The complete dataset comprises 9338 character codings, of which 781 are
inapplicable and 3887 were neither ambiguous nor inapplicable. The
...
Of the 203 characters, the number that were coded with an applicable
...
\hline
\_Loxosomella\_ & 150   \&nbsp; & \_Askepasma toddense\_ & 68   \&nbsp; & \_Micrina\_ & 61   \&nbsp;\\
\hline
\_Flustra\_ & 152   \&nbsp; & \_Antigonambonites planus\_ & 75   \&nbsp; & \_Micromitra\_ & 72   \&nbsp;\\
\hline
\_Novocrania\_ & 174   \&nbsp; & \_Botsfordia\_ & 67   \&nbsp; & \_Mickwitzia muralensis\_ & 65   \&nbsp;\\
\hline
\_Lingula\_ & 182   \&nbsp; & \_Clupeafumosus socialis\_ & 69   \&nbsp; & \_Mummpikia nuda\_ & 47   \&nbsp;\\
\hline
\_Phoronis\_ & 132   \&nbsp; & \_Coolinia pecten\_ & 71   \&nbsp; & \_Nisusia sulcata\_ & 76   \&nbsp;\\
\hline
\_Sipunculus\_ & 155   \&nbsp; & \_Craniops\_ & 59   \&nbsp; & \_Orthis\_ & 65   \&nbsp;\\
\hline
\_Serpula\_ & 156   \&nbsp; & \_Eccentrotheca\_ & 40   \&nbsp; & \_Paterimitra\_ & 57   \&nbsp;\\
\hline
\_Tonicella\_ & 170   \&nbsp; & \_Eoobolus\_ & 73   \&nbsp; & \_Pedunculotheca diania\_ & 62   \&nbsp;\\
\hline
\_Dentalium\_ & 154   \&nbsp; & \_Glyptoria\_ & 68   \&nbsp; & \_Salanygolina\_ & 69   \&nbsp;\\
\hline
\_Pelagodiscus atlanticus\_ & 134   \&nbsp; & \_Gasconsia\_ & 63   \&nbsp; & \_Siphonobolus priscus\_ & 66   \&nbsp;\\
\hline
\_Terebratulina\_ & 139   \&nbsp; & \_Haplophrentis carinatus\_ & 68   \&nbsp; & \_Ussunia\_ & 44   \&nbsp;\\
\hline
\_Wiwaxia corrugata\_ & 64   \&nbsp; & \_Heliomedusa orienta\_ & 61   \&nbsp; & \_Tomteluva perturbata\_ & 53   \&nbsp;\\
\hline
\_Halkieria evangelista\_ & 57   \&nbsp; & \_Kutorgina chengjiangensis\_ & 78   \&nbsp; & \_Yuganotheca elegans\_ & 49   \&nbsp;\\
\hline
\_Dailyatia\_ & 41   \&nbsp; & \_Lingulosacculus\_ & 53   \&nbsp; &  & \\
\hline
...
\url{https://raw.githubusercontent.com/ms609/hyoliths/master/mbank_X24932_6-1-2018_630.nex}
.
...
inapplicable codings (781/9338 = 8.4\% of tokens), which are known to
...
\addcontentsline{toc}{subsection}{{[}10{]} Distribution}
...
\addcontentsline{toc}{subsection}{{[}11{]} Serial repetition}
...
\addcontentsline{toc}{subsection}{{[}12{]} Foot}
...
\addcontentsline{toc}{subsection}{{[}13{]} Number}
...
\addcontentsline{toc}{subsection}{{[}16{]} Constitution}
...
\addcontentsline{toc}{subsection}{{[}17{]} Biomineralization}
...
\addcontentsline{toc}{subsection}{{[}18{]} Bulb}
...
\addcontentsline{toc}{subsection}{{[}19{]} Distal rootlets}
...
\addcontentsline{toc}{subsection}{{[}20{]} Tapering}
...
\addcontentsline{toc}{subsection}{{[}21{]} Coelomic region}
...
\addcontentsline{toc}{subsection}{{[}22{]} Surface ornament}
...
\addcontentsline{toc}{subsection}{{[}23{]} Nerve impression}
...
\addcontentsline{toc}{subsection}{{[}24{]} Presence}
...
\addcontentsline{toc}{subsection}{{[}25{]} Morphology}
...
\addcontentsline{toc}{subsection}{{[}26{]} \emph{vascula}
\emph{lateralia}}
...
\addcontentsline{toc}{subsection}{{[}27{]} \emph{vascula} \emph{media}}
...
\addcontentsline{toc}{subsection}{{[}28{]} \emph{vascula}
\emph{terminalia}}
...
\addcontentsline{toc}{subsection}{{[}30{]} Origin}
...
\addcontentsline{toc}{subsection}{{[}31{]} Tentacle disposition}
...
\addcontentsline{toc}{subsection}{{[}32{]} Tentacle rows per side in
trocholophe stage}
...
\addcontentsline{toc}{subsection}{{[}33{]} Tentacle rows per side in
...
\addcontentsline{toc}{subsection}{{[}34{]} Median tentacle in early
development}
...
\addcontentsline{toc}{subsection}{{[}35{]} Site of tentacle addition}
...
\addcontentsline{toc}{subsection}{{[}36{]} Innervation}
...
\addcontentsline{toc}{subsection}{{[}37{]} Inner nerve ring}
...
\addcontentsline{toc}{subsection}{{[}38{]} Outer nerve ring}
...
\addcontentsline{toc}{subsection}{{[}39{]} Forms closed loop}
...
\addcontentsline{toc}{subsection}{{[}40{]} Coiling direction}
...
\addcontentsline{toc}{subsection}{{[}41{]} Adjustor muscle}
...
\addcontentsline{toc}{subsection}{{[}42{]} Prominent pharynx}
...
\addcontentsline{toc}{subsection}{{[}43{]} Radula}
...
\addcontentsline{toc}{subsection}{{[}44{]} Oesophageal folds}
...
\addcontentsline{toc}{subsection}{{[}45{]} Oral sphincter}
...
\addcontentsline{toc}{subsection}{{[}46{]} Locomotory cilia}
...
\addcontentsline{toc}{subsection}{{[}47{]} Subdivisions}
...
\addcontentsline{toc}{subsection}{{[}48{]} Glands}
...
\addcontentsline{toc}{subsection}{{[}49{]} Presence}
...
\addcontentsline{toc}{subsection}{{[}50{]} Location}
...
\addcontentsline{toc}{subsection}{{[}51{]} Migration: Within ring of
tentacles}
...
\addcontentsline{toc}{subsection}{{[}52{]} Migration: Position}
...
\addcontentsline{toc}{subsection}{{[}53{]} Present in adult}
...
\addcontentsline{toc}{subsection}{{[}55{]} Accessory sclerites reduced}
...
\addcontentsline{toc}{subsection}{{[}56{]} Arrangement}
...
\addcontentsline{toc}{subsection}{{[}57{]} Symmetry}
...
\addcontentsline{toc}{subsection}{{[}58{]} Hinge line shape}
...
\addcontentsline{toc}{subsection}{{[}59{]} Apophyses}
...
\addcontentsline{toc}{subsection}{{[}60{]} Apophyses: Morphology}
...
\addcontentsline{toc}{subsection}{{[}61{]} Apophyses: Dental plates}
...
\addcontentsline{toc}{subsection}{{[}62{]} Sockets}
...
\addcontentsline{toc}{subsection}{{[}63{]} Socket ridges}
...
\addcontentsline{toc}{subsection}{{[}64{]} Enclosing filtration chamber}
...
\addcontentsline{toc}{subsection}{{[}65{]} Commissure}
...
\addcontentsline{toc}{subsection}{{[}66{]} Muscle scars: Ventral}
...
\addcontentsline{toc}{subsection}{{[}67{]} Muscle scars: Ventral:
Position}
...
\addcontentsline{toc}{subsection}{{[}68{]} Muscle scars: Adjustor}
...
\addcontentsline{toc}{subsection}{{[}69{]} Muscle scars: Dorsal
adductors}
...
\addcontentsline{toc}{subsection}{{[}70{]} Muscle scars: Adductors:
Position}
...
\addcontentsline{toc}{subsection}{{[}71{]} Muscle scars: Dermal muscles}
...
\addcontentsline{toc}{subsection}{{[}72{]} Muscle scars: Unpaired median
(\emph{levator ani})}
...
\addcontentsline{toc}{subsection}{{[}73{]} Muscle scars: Dorsal
diductor}
...
\addcontentsline{toc}{subsection}{{[}75{]} Growth direction}
...
\addcontentsline{toc}{subsection}{{[}76{]} Posterior surface:
Differentiated}
...
\addcontentsline{toc}{subsection}{{[}77{]} Differentiated posterior
surface: Morphology}
...
\addcontentsline{toc}{subsection}{{[}78{]} Posterior surface: Medial
groove}
...
\addcontentsline{toc}{subsection}{{[}80{]} Posterior surface:
Notothyrium: Shape}
...
\addcontentsline{toc}{subsection}{{[}82{]} Notothyrial platform}
...
\addcontentsline{toc}{subsection}{{[}83{]} Cardinal shield}
...
\addcontentsline{toc}{subsection}{{[}84{]} Cardinal processes}
...
\addcontentsline{toc}{subsection}{{[}85{]} Medial septum}
...
\addcontentsline{toc}{subsection}{{[}86{]} Clavicles}
...
\addcontentsline{toc}{subsection}{{[}87{]} Relative size}
...
\addcontentsline{toc}{subsection}{{[}90{]} Posterior margin growth
direction}
...
\addcontentsline{toc}{subsection}{{[}91{]} Posterior surface: Planar}
...
\addcontentsline{toc}{subsection}{{[}92{]} Posterior surface: Extent}
...
\addcontentsline{toc}{subsection}{{[}101{]} Umbonal perforation}
...
\addcontentsline{toc}{subsection}{{[}102{]} Umbonal perforation: Shape}
...
\addcontentsline{toc}{subsection}{{[}103{]} Colleplax, cicatrix or
pedicle sheath}
...
\addcontentsline{toc}{subsection}{{[}104{]} Median septum}
...
\addcontentsline{toc}{subsection}{{[}105{]} Concentric ornament}
...
\addcontentsline{toc}{subsection}{{[}106{]} Concentric ornament:
Symmetry}
...
\addcontentsline{toc}{subsection}{{[}107{]} Radial ornament}
...
\addcontentsline{toc}{subsection}{{[}108{]} Shell-penetrating spines}
...
\addcontentsline{toc}{subsection}{{[}109{]} Mineralogy}
...
\hypertarget{Cotyledion_tylodes-coding-109}{}
...
\hypertarget{Craniops-coding-109}{}
...
\hypertarget{Lingulosacculus-coding-109}{}
...
\addcontentsline{toc}{subsection}{{[}110{]} Cuticle or organic matrix}
...
\addcontentsline{toc}{subsection}{{[}111{]} Incorporation of sedimentary
particles}
...
\addcontentsline{toc}{subsection}{{[}112{]} Periostracum: Flexibility}
...
\addcontentsline{toc}{subsection}{{[}113{]} Microstructure: Layers}
...
\addcontentsline{toc}{subsection}{{[}114{]} Microstructure: Crystal
format}
...
\addcontentsline{toc}{subsection}{{[}115{]} Microstructure: Punctae}
...
\addcontentsline{toc}{subsection}{{[}116{]} Microstructure: Canals}
...
\addcontentsline{toc}{subsection}{{[}117{]} Microstructure:
Pseudopunctae}
...
\addcontentsline{toc}{subsection}{{[}118{]} Microstructure: External
polygonal ornament}
...
\addcontentsline{toc}{subsection}{{[}119{]} Periodically shed and
replaced}
...
\addcontentsline{toc}{subsection}{{[}120{]} Egg size}
...
\addcontentsline{toc}{subsection}{{[}121{]} Gonocoel}
...
\addcontentsline{toc}{subsection}{{[}122{]} Ovary wall saccular}
...
\addcontentsline{toc}{subsection}{{[}123{]} Testis wall saccular}
...
\addcontentsline{toc}{subsection}{{[}124{]} Asexual reproduction}
...
\addcontentsline{toc}{subsection}{{[}125{]} Fertilization}
...
\addcontentsline{toc}{subsection}{{[}126{]} Sexes}
...
\addcontentsline{toc}{subsection}{{[}127{]} Protective membrane}
...
\addcontentsline{toc}{subsection}{{[}129{]} Nucleus: Shape}
...
\addcontentsline{toc}{subsection}{{[}130{]} Anterior nuclear fossa}
...
\addcontentsline{toc}{subsection}{{[}131{]} Acrosome: Shape}
...
\addcontentsline{toc}{subsection}{{[}132{]} Acrosome: Differentiated
internally}
...
\addcontentsline{toc}{subsection}{{[}133{]} Acrosome: Sub-acrosomal
space}
...
\addcontentsline{toc}{subsection}{{[}134{]} Mid-piece}
...
\addcontentsline{toc}{subsection}{{[}135{]} Centrioles: Orientation}
...
\addcontentsline{toc}{subsection}{{[}136{]} Centrioles: Fusion}
...
\addcontentsline{toc}{subsection}{{[}137{]} Satellite fibre complex}
...
\addcontentsline{toc}{subsection}{{[}138{]} Mitochondria: Shape}
...
\addcontentsline{toc}{subsection}{{[}139{]} Mitochondria: Cristae:
Configuration}
...
\addcontentsline{toc}{subsection}{{[}140{]} Mitochondria: Midpiece}
...
\addcontentsline{toc}{subsection}{{[}141{]} Equal}
...
\addcontentsline{toc}{subsection}{{[}142{]} Cross pattern}
...
\addcontentsline{toc}{subsection}{{[}143{]} Polar lobe formation}
...
\addcontentsline{toc}{subsection}{{[}144{]} Spiral}
...
\addcontentsline{toc}{subsection}{{[}146{]} Origin of mesoderm}
...
\addcontentsline{toc}{subsection}{{[}147{]} Metatroch}
...
\addcontentsline{toc}{subsection}{{[}148{]} Telotroch}
...
\addcontentsline{toc}{subsection}{{[}149{]} Feeding}
...
\addcontentsline{toc}{subsection}{{[}150{]} Ciliated food groove}
...
\addcontentsline{toc}{subsection}{{[}151{]} Ciliary bands: Downstream}
...
\addcontentsline{toc}{subsection}{{[}152{]} Ciliary bands: Upstream}
...
\addcontentsline{toc}{subsection}{{[}153{]} Adoral ciliary band}
...
\addcontentsline{toc}{subsection}{{[}155{]} Paired dorsal setal bundles}
...
\addcontentsline{toc}{subsection}{{[}156{]} Muscles extending to the
hyposphere}
...
\addcontentsline{toc}{subsection}{{[}157{]} Serotonergic cells}
...
\addcontentsline{toc}{subsection}{{[}158{]} Develops into adult brain}
...
\addcontentsline{toc}{subsection}{{[}160{]} Serotonin-like
...
\addcontentsline{toc}{subsection}{{[}161{]} Origin of body cavity}
...
\addcontentsline{toc}{subsection}{{[}162{]} Formation of coelomoducts}
...
\addcontentsline{toc}{subsection}{{[}163{]} Paired}
...
\addcontentsline{toc}{subsection}{{[}164{]} Paried: Includes
pericardium}
...
\addcontentsline{toc}{subsection}{{[}165{]} Foot}
...
\addcontentsline{toc}{subsection}{{[}166{]} Accessory centriole}
...
\addcontentsline{toc}{subsection}{{[}167{]} Aggregation of granules
below basal plate}
...
\addcontentsline{toc}{subsection}{{[}168{]} Radiating tubular fibres}
...
\addcontentsline{toc}{subsection}{{[}170{]} Brushborder of microvilli}
...
\addcontentsline{toc}{subsection}{{[}171{]} Centriolar triplet
...
\addcontentsline{toc}{subsection}{{[}172{]} Ciliary necklace with
connecting strands}
...
\addcontentsline{toc}{subsection}{{[}174{]} Origin}
...
\addcontentsline{toc}{subsection}{{[}176{]} Branched}
...
\addcontentsline{toc}{subsection}{{[}177{]} Length}
...
\addcontentsline{toc}{subsection}{{[}178{]} Shape}
...
\addcontentsline{toc}{subsection}{{[}179{]} Presence}
...
\addcontentsline{toc}{subsection}{{[}182{]} Podocytes}
...
\addcontentsline{toc}{subsection}{{[}183{]} Rhogocytes}
...
\addcontentsline{toc}{subsection}{{[}184{]} Serve as excretory organs}
...
\addcontentsline{toc}{subsection}{{[}185{]} Protonephridia}
...
\addcontentsline{toc}{subsection}{{[}186{]} Metanephridia}
...
\addcontentsline{toc}{subsection}{{[}187{]} Layers}
...
\addcontentsline{toc}{subsection}{{[}188{]} Composition}
...
\emph{Dentalium}, \emph{Loxosomella}, \emph{Tonicella}:
...
\subsection*{{[}189{]} Resilience}\label{resilience}
\addcontentsline{toc}{subsection}{{[}189{]} Resilience}

\includegraphics{Brachiopod_phylogeny_files/figure-latex/character-mapping-188.pdf}

\begin{quote}
\textbf{Character 189: Cuticle: Resilience}
...
\subsection*{{[}190{]} Cytology}\label{cytology}
\addcontentsline{toc}{subsection}{{[}190{]} Cytology}

\includegraphics{Brachiopod_phylogeny_files/figure-latex/character-mapping-189.pdf}

\begin{quote}
\textbf{Character 190: Muscles: Cytology}
...
\subsection*{{[}191{]} Histology}\label{histology}
\addcontentsline{toc}{subsection}{{[}191{]} Histology}

\includegraphics{Brachiopod_phylogeny_files/figure-latex/character-mapping-190.pdf}

\begin{quote}
\textbf{Character 191: Muscles: Histology}
...
\subsection*{{[}192{]} Pedal gland}\label{pedal-gland}
\addcontentsline{toc}{subsection}{{[}192{]} Pedal gland}

\includegraphics{Brachiopod_phylogeny_files/figure-latex/character-mapping-191.pdf}

\begin{quote}
\textbf{Character 192: Glands: Pedal gland}
...
\subsection*{{[}193{]} Paired pharyngeal
diverticulae}\label{paired-pharyngeal-diverticulae}
\addcontentsline{toc}{subsection}{{[}193{]} Paired pharyngeal
diverticulae}

\includegraphics{Brachiopod_phylogeny_files/figure-latex/character-mapping-192.pdf}

\begin{quote}
\textbf{Character 193: Glands: Paired pharyngeal diverticulae}
...
{[}194{]}}\label{body-organization-circulatory-system-194}

\includegraphics{Brachiopod_phylogeny_files/figure-latex/character-mapping-193.pdf}

\begin{quote}
\textbf{Character 194: Body organization: Circulatory system}
...
\subsection*{{[}195{]} Orthogonal}\label{orthogonal}
\addcontentsline{toc}{subsection}{{[}195{]} Orthogonal}

\includegraphics{Brachiopod_phylogeny_files/figure-latex/character-mapping-194.pdf}

\begin{quote}
\textbf{Character 195: Nervous system: Orthogonal}
...
\subsection*{{[}196{]} Glial system}\label{glial-system}
\addcontentsline{toc}{subsection}{{[}196{]} Glial system}

\includegraphics{Brachiopod_phylogeny_files/figure-latex/character-mapping-195.pdf}

\begin{quote}
\textbf{Character 196: Nervous system: Glial system}
...
\subsection*{{[}197{]} Buccal nerve ring}\label{buccal-nerve-ring}
\addcontentsline{toc}{subsection}{{[}197{]} Buccal nerve ring}

\includegraphics{Brachiopod_phylogeny_files/figure-latex/character-mapping-196.pdf}

\begin{quote}
\textbf{Character 197: Nervous system: Buccal nerve ring}
...
\subsection*{{[}198{]} Anterior nerve loop}\label{anterior-nerve-loop}
\addcontentsline{toc}{subsection}{{[}198{]} Anterior nerve loop}

\includegraphics{Brachiopod_phylogeny_files/figure-latex/character-mapping-197.pdf}

\begin{quote}
\textbf{Character 198: Nervous system: Anterior nerve loop}
...
\subsection*{{[}199{]} Formation of ganglia}\label{formation-of-ganglia}
\addcontentsline{toc}{subsection}{{[}199{]} Formation of ganglia}

\includegraphics{Brachiopod_phylogeny_files/figure-latex/character-mapping-198.pdf}

\begin{quote}
\textbf{Character 199: Nervous system: Formation of ganglia}
...
\subsection*{{[}200{]} Presence}\label{presence-5}
\addcontentsline{toc}{subsection}{{[}200{]} Presence}

\includegraphics{Brachiopod_phylogeny_files/figure-latex/character-mapping-199.pdf}

\begin{quote}
\textbf{Character 200: Nervous system: Cerebral ganglia: Presence}
...
\subsection*{{[}201{]} Fused}\label{fused}
\addcontentsline{toc}{subsection}{{[}201{]} Fused}

\includegraphics{Brachiopod_phylogeny_files/figure-latex/character-mapping-200.pdf}

\begin{quote}
\textbf{Character 201: Nervous system: Cerebral gangila: Fused}
...
{[}202{]}}\label{nervous-system-nerve-cords-202}

\includegraphics{Brachiopod_phylogeny_files/figure-latex/character-mapping-201.pdf}

\begin{quote}
\textbf{Character 202: Nervous system: Nerve cords}
...
\subsection*{{[}203{]} Ventral longitudinal
nerves}\label{ventral-longitudinal-nerves}
\addcontentsline{toc}{subsection}{{[}203{]} Ventral longitudinal nerves}

\includegraphics{Brachiopod_phylogeny_files/figure-latex/character-mapping-202.pdf}

\begin{quote}
\textbf{Character 203: Nervous system: Ventral longitudinal nerves}
...
\begin{quote}
charset Neomorphic = 1 5 6 7 9 11 12 14 15 18 19 23 24 26 27 29 32 33 34
...
166 167 168 170 172 173 174 176 179 182 183 184 185 186 187 189 190 191
192 193 195 196 197 198 199 200 203;

charset Transformational = 2 3 4 8 10 13 16 17 20 21 22 25 28 30 31 35
...
146 149 159 160 161 162 169 171 175 177 178 180 181 188 194 201 202;
