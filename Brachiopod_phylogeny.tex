...
Of the 107 character, the number of coded entries for each taxon is:
...
the main manuscript.{]} A static version of the NEXUS file used to
generate this supplementary information can be downloaded directly from
