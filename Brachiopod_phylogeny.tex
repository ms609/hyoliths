\documentclass[9pt,twoside,openany]{pnas-new}
\usepackage{lmodern}
...
\hypersetup{unicode=true,
            pdftitle={Hyoliths with pedicles constrain the origin of the brachiopod body plan},
...
\setlength{\droptitle}{-2em}
  \title{Hyoliths with pedicles constrain the origin of the brachiopod body plan}
...
Supplementary \protect\hyperlink{si}{figures and tables} referenced in
the main text appear first. These are followed with a detailed
discussion of \protect\hyperlink{treesearch}{analyses} of the
...
parsimony setting. We explore how each character is
...
\hypertarget{si}{\section{Supplementary Figures and Table
\{-\}}\label{si}}
...
\caption{\textbf{\emph{Pedunculotheca diania} Sun et Smith gen.
et sp. nov. from the Chengjiang Biota, Yunnan Province, China.} (a)
NIGPAS 166601, external mould of dorsum with dorsal apex and pedicle
foramen. (b) NIGPAS 166597, preserving conical shell, operculum and
internal soft tissue, showing a compressed elliptic cross-section;
backscatter electron micrograph of boxed region shown in (c). (d) NIGPAS
166599b, counterpart, juvenile conical shell with operculum showing two
...
boxed region shown in (h). (i) NIGPAS 166603, exterior of
operculum.\newline
Scale bars: 2mm (for a, b and e--g); 500~µm (for c, h and i).\newline
Abbreviations: an = anus, cc = coelomic cavity, da = dorsal apex, es =
esophagus, in = intestine, mo = mouth, pe = pedicle, st = stomach.}\label{fig:unnamed-chunk-1}
\end{figure}
...
\caption{\textbf{Elemental distribution in the gut of
...
Silicon, Al = Aluminium, Fe = Iron, C = Carbon.}\label{fig:unnamed-chunk-2}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-3}\textbf{Global diversity of brachiopods through the
Paleozoic.} Points represent number of genera reported in each time bin;
...
\caption{\label{tab:table-s1}\textbf{Provenance of fossil material.} Individuals from
the Yaoying section are usually bigger, with a thicker body wall, and
have a smaller ratio of apertural width to shell length than specimens
from other areas. In the absence of other differentiating features, we
...
\hypertarget{treesearch}{\section{Parsimony analysis}\label{treesearch}}
...
\subsection{Search parameters}\label{search-parameters}
...
\subsubsection{Initialize and load data}\label{initialize-and-load-data}
...
\subsubsection{Generate starting tree}\label{generate-starting-tree}
...
\subsubsection{Implied weights analysis}\label{implied-weights-analysis}
...
\subsubsection{Equal weights analysis}\label{equal-weights-analysis}
...
\subsubsection{Implied weights results}\label{implied-weights-results}
...
\subsubsection{Equal weights results}\label{equal-weights-results}
...
\hypertarget{reconstructions}{\section{Character
...
the figures below are simply to facilitate interpretation.

\subsection{Sclerites}\label{sclerites}

\subsubsection*{{[}1{]} Present in adult}\label{present-in-adult}
\addcontentsline{toc}{subsubsection}{{[}1{]} Present in adult}
...
\subsection{Sclerites: Bivalved {[}2{]}}\label{sclerites-bivalved-2}
...
\subsubsection*{{[}3{]} Accessory sclerites
reduced}\label{accessory-sclerites-reduced}
\addcontentsline{toc}{subsubsection}{{[}3{]} Accessory sclerites
reduced}
...
\subsubsection*{{[}4{]} Hinge line shape}\label{hinge-line-shape}
\addcontentsline{toc}{subsubsection}{{[}4{]} Hinge line shape}
...
\citep[p.~208]{Williams2000BrachiopodaLinguliformea}.
...
\subsubsection*{{[}5{]} Apophyses}\label{apophyses}
\addcontentsline{toc}{subsubsection}{{[}5{]} Apophyses}
...
\subsubsection*{{[}6{]} Apophyses:
Morphology}\label{apophyses-morphology}
\addcontentsline{toc}{subsubsection}{{[}6{]} Apophyses: Morphology}
...
\subsubsection*{{[}7{]} Apophyses: Dental
plates}\label{apophyses-dental-plates}
\addcontentsline{toc}{subsubsection}{{[}7{]} Apophyses: Dental plates}
...
\subsubsection*{{[}8{]} Sockets}\label{sockets}
\addcontentsline{toc}{subsubsection}{{[}8{]} Sockets}
...
\subsubsection*{{[}9{]} Socket ridges}\label{socket-ridges}
\addcontentsline{toc}{subsubsection}{{[}9{]} Socket ridges}
...
\subsubsection*{{[}10{]} Enclosing filtration
chamber}\label{enclosing-filtration-chamber}
\addcontentsline{toc}{subsubsection}{{[}10{]} Enclosing filtration
chamber}
...
\subsubsection*{{[}11{]} Commissure}\label{commissure}
\addcontentsline{toc}{subsubsection}{{[}11{]} Commissure}
...
\subsubsection*{{[}12{]} Muscle scars:
Ventral}\label{muscle-scars-ventral}
\addcontentsline{toc}{subsubsection}{{[}12{]} Muscle scars: Ventral}
...
\subsubsection*{{[}13{]} Muscle scars: Ventral:
Position}\label{muscle-scars-ventral-position}
\addcontentsline{toc}{subsubsection}{{[}13{]} Muscle scars: Ventral:
Position}
...
\subsubsection*{{[}14{]} Muscle scars:
Adjustor}\label{muscle-scars-adjustor}
\addcontentsline{toc}{subsubsection}{{[}14{]} Muscle scars: Adjustor}
...
\subsubsection*{{[}15{]} Muscle scars: Dorsal
adductors}\label{muscle-scars-dorsal-adductors}
\addcontentsline{toc}{subsubsection}{{[}15{]} Muscle scars: Dorsal
adductors}
...
\subsubsection*{{[}16{]} Muscle scars: Adductors:
Position}\label{muscle-scars-adductors-position}
\addcontentsline{toc}{subsubsection}{{[}16{]} Muscle scars: Adductors:
Position}
...
\subsubsection*{{[}17{]} Muscle scars: Dermal
muscles}\label{muscle-scars-dermal-muscles}
\addcontentsline{toc}{subsubsection}{{[}17{]} Muscle scars: Dermal
muscles}
...
al}. \citeyearpar[p.~32]{Williams2000BrachiopodaLinguliformea} that
...
\subsubsection*{\texorpdfstring{{[}18{]} Muscle scars: Unpaired median
(\emph{levator
ani})}{{[}18{]} Muscle scars: Unpaired median (levator ani)}}\label{muscle-scars-unpaired-median-levator-ani}
\addcontentsline{toc}{subsubsection}{{[}18{]} Muscle scars: Unpaired
median (\emph{levator ani})}
...
{[}\citet{Williams2000BrachiopodaLinguliformea}; see fig. 89, character
34 in table 13{]}.
...
\subsubsection*{{[}19{]} Muscle scars: Dorsal
diductor}\label{muscle-scars-dorsal-diductor}
\addcontentsline{toc}{subsubsection}{{[}19{]} Muscle scars: Dorsal
diductor}
...
\subsubsection*{{[}20{]} Muscle scars: Dorsal diductor:
Position}\label{muscle-scars-dorsal-diductor-position}
\addcontentsline{toc}{subsubsection}{{[}20{]} Muscle scars: Dorsal
diductor: Position}
...
\subsection{Sclerites: Dorsal valve}\label{sclerites-dorsal-valve}

\subsubsection*{{[}21{]} Growth direction}\label{growth-direction}
\addcontentsline{toc}{subsubsection}{{[}21{]} Growth direction}
...
\subsubsection*{{[}22{]} Posterior surface:
Differentiated}\label{posterior-surface-differentiated}
\addcontentsline{toc}{subsubsection}{{[}22{]} Posterior surface:
Differentiated}
...
\subsubsection*{{[}23{]} Differentiated posterior surface:
Morphology}\label{differentiated-posterior-surface-morphology}
\addcontentsline{toc}{subsubsection}{{[}23{]} Differentiated posterior
surface: Morphology}
...
\subsubsection*{{[}24{]} Posterior surface: Medial
groove}\label{posterior-surface-medial-groove}
\addcontentsline{toc}{subsubsection}{{[}24{]} Posterior surface: Medial
groove}
...
\subsubsection*{{[}25{]} Posterior surface:
Notothyrium}\label{posterior-surface-notothyrium}
\addcontentsline{toc}{subsubsection}{{[}25{]} Posterior surface:
Notothyrium}
...
\subsubsection*{{[}26{]} Posterior surface: Notothyrium:
Shape}\label{posterior-surface-notothyrium-shape}
\addcontentsline{toc}{subsubsection}{{[}26{]} Posterior surface:
Notothyrium: Shape}
...
\subsubsection*{{[}27{]} Posterior surface: Notothyrium: Chilidial
plates}\label{posterior-surface-notothyrium-chilidial-plates}
\addcontentsline{toc}{subsubsection}{{[}27{]} Posterior surface:
...
\subsubsection*{{[}28{]} Notothyrial
platform}\label{notothyrial-platform}
\addcontentsline{toc}{subsubsection}{{[}28{]} Notothyrial platform}
...
\subsubsection*{{[}29{]} Cardinal shield}\label{cardinal-shield}
\addcontentsline{toc}{subsubsection}{{[}29{]} Cardinal shield}
...
\subsubsection*{{[}30{]} Cardinal processes}\label{cardinal-processes}
\addcontentsline{toc}{subsubsection}{{[}30{]} Cardinal processes}
...
\subsubsection*{{[}31{]} Medial septum}\label{medial-septum}
\addcontentsline{toc}{subsubsection}{{[}31{]} Medial septum}
...
\subsubsection*{{[}32{]} Clavicles}\label{clavicles}
\addcontentsline{toc}{subsubsection}{{[}32{]} Clavicles}
...
\subsection{Sclerites: Ventral valve}\label{sclerites-ventral-valve}

\subsubsection*{{[}33{]} Relative size}\label{relative-size}
\addcontentsline{toc}{subsubsection}{{[}33{]} Relative size}
...
\subsubsection*{{[}34{]} Growth direction}\label{growth-direction-1}
\addcontentsline{toc}{subsubsection}{{[}34{]} Growth direction}
...
\subsubsection*{{[}35{]} Posterior surface:
Differentiated}\label{posterior-surface-differentiated-1}
\addcontentsline{toc}{subsubsection}{{[}35{]} Posterior surface:
Differentiated}
...
\subsubsection*{{[}36{]} Posterior margin growth
direction}\label{posterior-margin-growth-direction}
\addcontentsline{toc}{subsubsection}{{[}36{]} Posterior margin growth
direction}
...
\subsubsection*{{[}37{]} Posterior surface:
Planar}\label{posterior-surface-planar}
\addcontentsline{toc}{subsubsection}{{[}37{]} Posterior surface: Planar}
...
\subsubsection*{{[}38{]} Posterior surface:
Extent}\label{posterior-surface-extent}
\addcontentsline{toc}{subsubsection}{{[}38{]} Posterior surface: Extent}
...
\subsubsection*{{[}39{]} Posterior surface:
Delthyrium}\label{posterior-surface-delthyrium}
\addcontentsline{toc}{subsubsection}{{[}39{]} Posterior surface:
Delthyrium}
...
\subsubsection*{{[}40{]} Posterior surface: Delthyrium:
Shape}\label{posterior-surface-delthyrium-shape}
\addcontentsline{toc}{subsubsection}{{[}40{]} Posterior surface:
Delthyrium: Shape}
...
\subsubsection*{{[}41{]} Posterior surface: Delthyrium: Shape: Aspect of
rounded
opening}\label{posterior-surface-delthyrium-shape-aspect-of-rounded-opening}
\addcontentsline{toc}{subsubsection}{{[}41{]} Posterior surface:
...
\subsubsection*{{[}42{]} Posterior surface: Delthyrium:
Cover}\label{posterior-surface-delthyrium-cover}
\addcontentsline{toc}{subsubsection}{{[}42{]} Posterior surface:
Delthyrium: Cover}
...
\subsubsection*{{[}43{]} Posterior surface: Delthyrium: Cover:
Extent}\label{posterior-surface-delthyrium-cover-extent}
\addcontentsline{toc}{subsubsection}{{[}43{]} Posterior surface:
...
\subsubsection*{{[}44{]} Posterior surface: Delthyrium: Cover:
Identity}\label{posterior-surface-delthyrium-cover-identity}
\addcontentsline{toc}{subsubsection}{{[}44{]} Posterior surface:
...
\subsubsection*{{[}45{]} Posterior surface: Delthyrium: Pseudodeltidium:
Shape}\label{posterior-surface-delthyrium-pseudodeltidium-shape}
\addcontentsline{toc}{subsubsection}{{[}45{]} Posterior surface:
...
\subsubsection*{{[}46{]} Posterior surface: Delthyrium: Pseudodeltidium:
Hinge
furrows}\label{posterior-surface-delthyrium-pseudodeltidium-hinge-furrows}
\addcontentsline{toc}{subsubsection}{{[}46{]} Posterior surface:
...
\subsubsection*{{[}47{]} Umbonal perforation}\label{umbonal-perforation}
\addcontentsline{toc}{subsubsection}{{[}47{]} Umbonal perforation}
...
\subsubsection*{{[}48{]} Umbonal perforation:
Shape}\label{umbonal-perforation-shape}
\addcontentsline{toc}{subsubsection}{{[}48{]} Umbonal perforation:
Shape}
...
\subsubsection*{{[}49{]} Colleplax, cicatrix or pedicle
sheath}\label{colleplax-cicatrix-or-pedicle-sheath}
\addcontentsline{toc}{subsubsection}{{[}49{]} Colleplax, cicatrix or
pedicle sheath}
...
\subsubsection*{{[}50{]} Median septum}\label{median-septum}
\addcontentsline{toc}{subsubsection}{{[}50{]} Median septum}
...
\subsection{Sclerites: Ornament}\label{sclerites-ornament}

\subsubsection*{{[}51{]} Concentric ornament}\label{concentric-ornament}
\addcontentsline{toc}{subsubsection}{{[}51{]} Concentric ornament}
...
\subsubsection*{{[}52{]} Concentric ornament:
Symmetry}\label{concentric-ornament-symmetry}
\addcontentsline{toc}{subsubsection}{{[}52{]} Concentric ornament:
Symmetry}
...
\subsubsection*{{[}53{]} Radial ornament}\label{radial-ornament}
\addcontentsline{toc}{subsubsection}{{[}53{]} Radial ornament}
...
\subsubsection*{{[}54{]} Shell-penetrating
spines}\label{shell-penetrating-spines}
\addcontentsline{toc}{subsubsection}{{[}54{]} Shell-penetrating spines}
...
\subsection{Sclerites: Composition}\label{sclerites-composition}

\subsubsection*{{[}55{]} Mineralogy}\label{mineralogy}
\addcontentsline{toc}{subsubsection}{{[}55{]} Mineralogy}
...
\subsubsection*{{[}56{]} Cuticle or organic
matrix}\label{cuticle-or-organic-matrix}
\addcontentsline{toc}{subsubsection}{{[}56{]} Cuticle or organic matrix}
...
\subsubsection*{{[}57{]} Incorporation of sedimentary
particles}\label{incorporation-of-sedimentary-particles}
\addcontentsline{toc}{subsubsection}{{[}57{]} Incorporation of
...
\subsubsection*{{[}58{]} Periostracum:
Flexibility}\label{periostracum-flexibility}
\addcontentsline{toc}{subsubsection}{{[}58{]} Periostracum: Flexibility}
...
\subsubsection*{{[}59{]} Microstructure:
Layers}\label{microstructure-layers}
\addcontentsline{toc}{subsubsection}{{[}59{]} Microstructure: Layers}
...
\subsubsection*{{[}60{]} Microstructure: Crystal
format}\label{microstructure-crystal-format}
\addcontentsline{toc}{subsubsection}{{[}60{]} Microstructure: Crystal
format}
...
Williams \emph{et al}.
\citeyearpar{Williams2000BrachiopodaLinguliformea} identify cross-bladed
laminae as diagnostic of Strophomenata, with the exception of some older
groups that contain fibres or laminar laths.
...
\subsubsection*{{[}61{]} Microstructure:
Punctae}\label{microstructure-punctae}
\addcontentsline{toc}{subsubsection}{{[}61{]} Microstructure: Punctae}
...
\citep{Williams1997BrachiopodaRevised}. Punctae are 10--20 µm wide and
...
size \citep{Williams1997BrachiopodaRevised}. Punctae are 10--20 µm wide
...
\subsubsection*{{[}62{]} Microstructure:
Canals}\label{microstructure-canals}
\addcontentsline{toc}{subsubsection}{{[}62{]} Microstructure: Canals}
...
\subsubsection*{{[}63{]} Microstructure:
Pseudopunctae}\label{microstructure-pseudopunctae}
\addcontentsline{toc}{subsubsection}{{[}63{]} Microstructure:
Pseudopunctae}
...
\subsubsection*{{[}64{]} Microstructure: External polygonal
ornament}\label{microstructure-external-polygonal-ornament}
\addcontentsline{toc}{subsubsection}{{[}64{]} Microstructure: External
polygonal ornament}
...
\subsection{Gametes}\label{gametes}

\subsubsection*{{[}65{]} Egg size}\label{egg-size}
\addcontentsline{toc}{subsubsection}{{[}65{]} Egg size}
...
\subsubsection*{{[}66{]} Site of maturation}\label{site-of-maturation}
\addcontentsline{toc}{subsubsection}{{[}66{]} Site of maturation}
...
\subsection{Gametes: Spermatozoa}\label{gametes-spermatozoa}

\subsubsection*{{[}67{]} Nucleus: Broad anterior
invagination}\label{nucleus-broad-anterior-invagination}
\addcontentsline{toc}{subsubsection}{{[}67{]} Nucleus: Broad anterior
invagination}
...
\subsubsection*{{[}68{]} Acrosome: Shape}\label{acrosome-shape}
\addcontentsline{toc}{subsubsection}{{[}68{]} Acrosome: Shape}
...
\subsubsection*{{[}69{]} Acrosome: Differentiated
internally}\label{acrosome-differentiated-internally}
\addcontentsline{toc}{subsubsection}{{[}69{]} Acrosome: Differentiated
internally}
...
\subsubsection*{{[}70{]} Acrosome: Sub-acrosomal
space}\label{acrosome-sub-acrosomal-space}
\addcontentsline{toc}{subsubsection}{{[}70{]} Acrosome: Sub-acrosomal
space}
...
\subsubsection*{{[}71{]} Mid-piece}\label{mid-piece}
\addcontentsline{toc}{subsubsection}{{[}71{]} Mid-piece}
...
\subsubsection*{{[}72{]} Centrioles}\label{centrioles}
\addcontentsline{toc}{subsubsection}{{[}72{]} Centrioles}
...
\subsection{Brephic shell}\label{brephic-shell}

\subsubsection*{{[}73{]} Embryonic shell}\label{embryonic-shell}
\addcontentsline{toc}{subsubsection}{{[}73{]} Embryonic shell}
...
\subsubsection*{{[}74{]} Morphology}\label{morphology}
\addcontentsline{toc}{subsubsection}{{[}74{]} Morphology}
...
\subsubsection*{{[}75{]} Embryonic shell extended in
larvae}\label{embryonic-shell-extended-in-larvae}
\addcontentsline{toc}{subsubsection}{{[}75{]} Embryonic shell extended
in larvae}
...
\subsubsection*{{[}76{]} Surface ornament}\label{surface-ornament}
\addcontentsline{toc}{subsubsection}{{[}76{]} Surface ornament}
...
family-level codings of \citet{Williams2000BrachiopodaLinguliformea},
table 6.
...
\subsubsection*{{[}77{]} Larval attachment
structure}\label{larval-attachment-structure}
\addcontentsline{toc}{subsubsection}{{[}77{]} Larval attachment
structure}
...
\subsubsection*{{[}78{]} Setulose}\label{setulose}
\addcontentsline{toc}{subsubsection}{{[}78{]} Setulose}
...
\subsection{Brephic shell: Setal sacs
...
\subsubsection*{{[}80{]} Number}\label{number}
\addcontentsline{toc}{subsubsection}{{[}80{]} Number}
...
\subsection{Setae}\label{setae}

\subsubsection*{{[}81{]} Present in adults}\label{present-in-adults}
\addcontentsline{toc}{subsubsection}{{[}81{]} Present in adults}
...
\subsubsection*{{[}82{]} Distribution}\label{distribution}
\addcontentsline{toc}{subsubsection}{{[}82{]} Distribution}
...
\subsection{Pedicle {[}83{]}}\label{pedicle-83}
...
\subsubsection*{{[}84{]} Constitution}\label{constitution}
\addcontentsline{toc}{subsubsection}{{[}84{]} Constitution}
...
\subsubsection*{{[}85{]} Biomineralization}\label{biomineralization}
\addcontentsline{toc}{subsubsection}{{[}85{]} Biomineralization}
...
\subsubsection*{{[}86{]} Bulb}\label{bulb}
\addcontentsline{toc}{subsubsection}{{[}86{]} Bulb}
...
\subsubsection*{{[}87{]} Distal rootlets}\label{distal-rootlets}
\addcontentsline{toc}{subsubsection}{{[}87{]} Distal rootlets}
...
\subsubsection*{{[}88{]} Tapering}\label{tapering}
\addcontentsline{toc}{subsubsection}{{[}88{]} Tapering}
...
\subsubsection*{{[}89{]} Coelomic region}\label{coelomic-region}
\addcontentsline{toc}{subsubsection}{{[}89{]} Coelomic region}
...
\subsubsection*{{[}90{]} Surface ornament}\label{surface-ornament-1}
\addcontentsline{toc}{subsubsection}{{[}90{]} Surface ornament}
...
\subsubsection*{{[}91{]} Nerve impression}\label{nerve-impression}
\addcontentsline{toc}{subsubsection}{{[}91{]} Nerve impression}
...
\subsection{Mantle canals}\label{mantle-canals}

\subsubsection*{{[}92{]} Morphology}\label{morphology-1}
\addcontentsline{toc}{subsubsection}{{[}92{]} Morphology}
...
\subsubsection*{\texorpdfstring{{[}93{]} \emph{vascula}
\emph{lateralia}}{{[}93{]} vascula lateralia}}\label{vascula-lateralia}
\addcontentsline{toc}{subsubsection}{{[}93{]} \emph{vascula}
\emph{lateralia}}
...
\subsubsection*{\texorpdfstring{{[}94{]} \emph{vascula}
\emph{media}}{{[}94{]} vascula media}}\label{vascula-media}
\addcontentsline{toc}{subsubsection}{{[}94{]} \emph{vascula}
\emph{media}}
...
\subsubsection*{\texorpdfstring{{[}95{]} \emph{vascula}
\emph{terminalia}}{{[}95{]} vascula terminalia}}\label{vascula-terminalia}
\addcontentsline{toc}{subsubsection}{{[}95{]} \emph{vascula}
\emph{terminalia}}
...
\subsection{Lophophore}\label{lophophore}

\subsubsection*{{[}96{]} Tentacle
disposition}\label{tentacle-disposition}
\addcontentsline{toc}{subsubsection}{{[}96{]} Tentacle disposition}
...
\subsubsection*{{[}97{]} Tentacle rows per side in trocholophe
stage}\label{tentacle-rows-per-side-in-trocholophe-stage}
\addcontentsline{toc}{subsubsection}{{[}97{]} Tentacle rows per side in
trocholophe stage}
...
\subsubsection*{{[}98{]} Tentacle rows per side in post-trocholophe
stage}\label{tentacle-rows-per-side-in-post-trocholophe-stage}
\addcontentsline{toc}{subsubsection}{{[}98{]} Tentacle rows per side in
...
\subsubsection*{{[}99{]} Median tentacle in early
development}\label{median-tentacle-in-early-development}
\addcontentsline{toc}{subsubsection}{{[}99{]} Median tentacle in early
development}
...
\subsubsection*{{[}100{]} Forms closed loop}\label{forms-closed-loop}
\addcontentsline{toc}{subsubsection}{{[}100{]} Forms closed loop}
...
\subsubsection*{{[}101{]} Coiling direction}\label{coiling-direction}
\addcontentsline{toc}{subsubsection}{{[}101{]} Coiling direction}
...
\subsubsection*{{[}102{]} Adjustor muscle}\label{adjustor-muscle}
\addcontentsline{toc}{subsubsection}{{[}102{]} Adjustor muscle}
...
\subsection{Prominent pharynx {[}103{]}}\label{prominent-pharynx-103}
...
\subsection{Anus {[}104{]}}\label{anus-104}
...
\subsubsection*{{[}105{]} Migration}\label{migration}
\addcontentsline{toc}{subsubsection}{{[}105{]} Migration}
...
\subsubsection*{{[}106{]} Within ring of
tentacles}\label{within-ring-of-tentacles}
\addcontentsline{toc}{subsubsection}{{[}106{]} Within ring of tentacles}
...
\subsubsection*{{[}107{]} Position}\label{position}
\addcontentsline{toc}{subsubsection}{{[}107{]} Position}
...
\hypertarget{fitch}{\section{Fitch parsimony}\label{fitch}}
...
\subsection{Implied weights}\label{implied-weights}
...
\hypertarget{bayesian}{\section{Bayesian analysis}\label{bayesian}}
...
\section{Taxonomic implications}\label{taxonomic-implications}
