...
\chapter*{Supplementary Figures and
Table}\label{supplementary-figures-and-table}
\addcontentsline{toc}{chapter}{Supplementary Figures and Table}
...
esophagus, in = intestine, mo = mouth, pe = pedicle, st = stomach.}\label{fig:more-specimens}
\end{figure}
...
Silicon, Al = Aluminium, Fe = Iron, C = Carbon.}\label{fig:gut-elemental}
\end{figure}
...
\caption{\label{fig:brach-diversity}\textbf{Global diversity of brachiopods through the
