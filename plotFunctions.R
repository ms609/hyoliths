...
taxonColour <- c(
  ...
  Novocrania                      = as.character(groupCol['Craniiformea']),
  Craniops                        = as.character(groupCol['Craniiformea']),
  Ussunia                         = as.character(groupCol['Craniiformea']),
  Gasconsia                       = as.character(groupCol['Craniiformea']),
  ...
  Lingula                         = as.character(groupCol['Linguliforms']),
  Eoobolus                        = as.character(groupCol['Linguliforms']),
  Botsfordia                      = as.character(groupCol['Linguliforms']),
  Siphonobolus_priscus            = as.character(groupCol['Linguliforms']),
  Siphonobolus                    = as.character(groupCol['Linguliforms']),
  Clupeafumosus_socialis          = as.character(groupCol['Linguliforms']),
  Clupeafumosus                   = as.character(groupCol['Linguliforms']),
  Lingulellotreta_malongensis     = as.character(groupCol['Linguliforms']),
  Lingulellotreta                 = as.character(groupCol['Linguliforms']),
  Acanthotretella_spinosa         = as.character(groupCol['Linguliforms']),
  Acanthotretella                 = as.character(groupCol['Linguliforms']),
  ...
  Paramicrocornus                 = as.character(groupCol['Hyolithids']),
  Pedunculotheca_diania           = as.character('black'),
  Pedunculotheca                  = as.character('black'),
  Haplophrentis_carinatus         = as.character(groupCol['Hyolithids']),
  Haplophrentis                   = as.character(groupCol['Hyolithids']),
  Maxilites                       = as.character(groupCol['Hyolithids']),
  Pauxillites                     = as.character(groupCol['Hyolithids']),
  Bactrotheca                     = as.character(groupCol['Orthothecids']),
  Conotheca                       = as.character(groupCol['Orthothecids']),
  Cupitheca_holocyclata           = as.character(groupCol['Orthothecids']),
  Cupitheca                       = as.character(groupCol['Orthothecids']),
  ...
  Alisina                         = as.character(groupCol['Rhynchonelliforms']),
  Glyptoria                       = as.character(groupCol['Rhynchonelliforms']),
  Orthis                          = as.character(groupCol['Rhynchonelliforms']),
  Terebratulina                   = as.character(groupCol['Rhynchonelliforms']))
