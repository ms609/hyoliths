...
The Nexus file used to generate these results in MrBayes can be `r GitLink("MrBayes/hyo.nex", "downloaded from", "downloaded here")`, 
and run from (MrBayes)[http://mrbayes.sourceforge.net/download.php] by typing `exe path/to/download`.
