...
To meet this criticism, we also present the results of tree searches with the algorithm described by @Brazeau2018, which correctly handles inapplicable data in a parsimony setting. Finally, we document how each character is most parsimoniously [reconstructed](#reconstructions) on optimal trees.
