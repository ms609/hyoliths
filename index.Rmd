...
output: 
  bookdown::pdf_book:
    includes:
      in_header: pnas_preamble.tex
    keep_tex: true
documentclass: pnas-new
classoption: 9pt,twoside,openany
bibliography: [References.bib,MorphoBank.bib]
csl: http://raw.githubusercontent.com/citation-style-language/styles/master/pnas.csl#apa-old-doi-prefix.csl
biblio-style: pnas-new
link-citations: yes
...
This document provides a detailed discussion of [analyses](#treesearch) of the [morphological dataset](#dataset) constructed to accompany @Sun2018Hyolithswith, and their results.  `r if (knitr::is_latex_output()) 'It is intended to be viewed in HTML format at \\href{https://ms609.github.io/hyoliths/}{ms609.github.io/hyoliths}.'`
...
Supplementary [figures](#figures) and [tables](#tables) referenced in the main text are included here as appendices.
