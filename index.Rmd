...
This document provides a detailed discussion of [analyses](#treesearch) of the [morphological dataset](#dataset) constructed to accompany @Sun2018Hyolithswith, and their results.  `r if (knitr::is_latex_output()) 'It is intended to be viewed in [HTML format](https://ms609.github.io/hyoliths/).'`
