...
```{r treesearch-all-iw-results, fig.cap="Implied weights results", fig.width=7.1, fig.height=4, echo=FALSE}
...
PlotPanel(1)
```
```{R treesearch-iw-results-2, echo=FALSE}
par(mfrow=c(1, 2), mar=rep(0.2, 4))
PlotPanel(2)
PlotPanel(3)
```
```{R treesearch-iw-results-3, echo=FALSE}
par(mfrow=c(1, 2), mar=rep(0.2, 4))
PlotPanel(4)
PlotPanel(5)
```
```{R treesearch-iw-results-4, echo=FALSE}
par(mfrow=c(1, 2), mar=rep(0.2, 4))
PlotPanel(6)
PlotPanel(7)
```
