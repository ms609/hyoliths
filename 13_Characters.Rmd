...
consistency_index <- CI(tree, my_data, sitewise=TRUE)
retention_index <- RI(tree, my_data, sitewise=TRUE)
...
for (i in seq_len(n_char)) {
  ...
  legend('bottomleft', paste0('CI = ', signif(consistency_index[i], 2),
                              '; RI = ', RetentionIndex(i)), bty='n')
