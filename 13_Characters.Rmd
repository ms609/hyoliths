...
function switchTree(input) {
  ...
  if (!isNaN(newValue)) {
    ...
    showTree(newValue, $(input).attr("char"));
  }
  return false;
}
...
function showTree(tree, char) {
  var oldTree = $('[data-char=' + char + ']', $my.trees);
  $.ajax({
  ...
  $my.trees.each(function()
    {
      ...
      $('.switcherNumber', switcherClone).attr("char", $(this).data("char"));
      $('input.switcherNumber', switcherClone).attr("char", $(this).data("char"));
