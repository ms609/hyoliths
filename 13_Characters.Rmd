...
if (knitr::is_html_output()) {
  ...
  for (i in eachTree) {
    ...
    analysisBoxes[i, ] <- paste0('<path d="M', svgWidth -1L, ',', 
                            ...
                            'h-156v14h156z" class="analysis"></path>') 
...
#for (i in seq_len(n_char)) {
  ...
  if (knitr::is_html_output()) {
    ...
    cat(paste0('<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="', 
                   svgWidth, '" height="', svgHeight, '" class="tree" char="', i, '">',
               svgSource, '</svg>'))
