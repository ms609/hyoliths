...
if (knitr::is_html_output()) {
  ...
  treeNames <- rep(c('Equal weights', paste0('Implied weights, k = ', kValues)), nTree)
  nTrees <- sum(nTree)
    ...
    for (treeNo in eachTree) {
      ...
      ciCaption <- paste0('<text x="', svgWidth,
                   ...
                   paste0(c('A most parsimonious tree under:',
                            treeNames[treeIndex==treeNo]),
                          collapse=paste0('</tspan><tspan x="', svgWidth, 
