...
fitch_steps <- fitch(tree, fitch_data, site='site')[attr(my_data, 'index')]
...
RetentionIndex <- function (i) {
  if (fitch_retention_index[i] == 'NaN') 'n/a' else signif(fitch_retention_index[i], 2)
}
...
for (i in seq_len(n_char)) {
  ...
  legend('bottomleft',  bty='n',
         paste0('CI = ', signif(min_steps[i] / character_reconstruction$score, 2),
                '; Fitch CI = ', signif(fitch_consistency_index[i], 2),
