...
A static version of the NEXUS file used to generate this supplementary information can be downloaded directly from https://raw.githubusercontent.com/ms609/hyoliths/master/`r gsub('^\\./', '', nexusFile)` .
