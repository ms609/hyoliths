...
: It's worth noting that Bayesian analysis (but no parsimony results) place _Gasconsia_ as the basalmost member of the Rhynchonellid lineage, upholding suggestions [@Holmer2014OrdovicianSilurian] of a chileid rather than trimerellid affinity.  On this view, _Gasconsia_ is a close analogue for the common ancestor of Rhynchonelliforms + Craniiforms (+Linguliforms?).
