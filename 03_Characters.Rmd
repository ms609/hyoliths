...
for (i in seq_len(n_char)) {
  ...
  ## NB we may need (in future?) to fix something:
  ## if a 2-part character follows a 3-parter, it doesn't print its name
  ## e.g. "Character: Thingamies: Item" followed by "Character: Wotsits"
  ## Wotsits will not appear as a subheading.
  if (char_nesting[i] == 1 && 
